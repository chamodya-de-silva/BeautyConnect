        ...
        <div className="min-h-screen bg-[#fafafa] overflow-hidden selection:bg-[--color-brand-purple] selection:text-white flex items-center justify-center relative">
            ...
            <div className="relative z-10 w-full max-w-lg p-8 sm:p-12 glass rounded-3xl shadow-2xl border border-white/50 backdrop-blur-xl">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 font-light">Log in to book your favorite services</p>
                </div>
                ...
                <form className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Link to="#" className="text-sm font-medium text-[#9F5AD5] hover:text-[--color-brand-purple-dark] transition-colors">
                            Forgot password?
                        </Link>
                    </div>
                    ...
                    <button
                        type="button"
                        className="w-full bg-[--color-brand-purple] text-white py-4 rounded-xl font-bold shadow-lg hover:shadow-xl hover:shadow-[--color-brand-purple]/20 transition-all duration-300 transform hover:-translate-y-0.5"
                    >
                        Sign In as Client
                    </button>
                </form>
                ...
                <div className="mt-8 text-center">
                    <p className="text-sm text-gray-600">
                        ...
                        <Link to="/register/client" className="font-semibold text-[#9F5AD5] hover:text-[--color-brand-purple-dark] transition-colors">
                            Sign up now
                        </Link>
                    </p>
